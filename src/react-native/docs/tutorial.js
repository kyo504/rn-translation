...
var Post = React.createClass({
  ...
  render: function() {
    return (
      <Layout metadata={{"id":"tutorial","title":"기본 배우기","layout":"docs","category":"The Basics","permalink":"docs/tutorial.html","next":"props","previous":"getting-started","filename":"Tutorial.md"}}>
        {content}
      </Layout>
    );
  }
