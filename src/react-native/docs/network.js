...
var Post = React.createClass({
  ...
  render: function() {
    return (
      <Layout metadata={{"id":"network","title":"네트워킹","layout":"docs","category":"The Basics","permalink":"docs/network.html","next":"more-resources","previous":"using-a-listview","filename":"Networking.md"}}>
        {content}
      </Layout>
    );
  }
