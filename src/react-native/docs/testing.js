...
var Post = React.createClass({
  ...
  render: function() {
    return (
      <Layout metadata={{"id":"testing","title":"Testing your Changes","layout":"docs","category":"Guides","permalink":"docs/testing.html","next":"understanding-cli","previous":"contributing","filename":"Testing.md"}}>
        {content}
      </Layout>
    );
  }
