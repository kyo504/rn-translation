...
var Post = React.createClass({
  ...
  render: function() {
    return (
      <Layout metadata={{"id":"handling-touches","title":"터치 핸들링하기","layout":"docs","category":"The Basics","permalink":"docs/handling-touches.html","next":"using-a-scrollview","previous":"handling-text-input","filename":"HandlingTouches.md"}}>
        {content}
      </Layout>
    );
  }
