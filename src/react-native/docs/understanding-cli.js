...
var Post = React.createClass({
  ...
  render: function() {
    return (
      <Layout metadata={{"id":"understanding-cli","title":"Understanding the CLI","layout":"docs","category":"Guides","permalink":"docs/understanding-cli.html","banner":"ejected","next":"native-modules-ios","previous":"testing","filename":"UnderstandingCLI.md"}}>
        {content}
      </Layout>
    );
  }
