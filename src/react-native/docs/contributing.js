...
var Post = React.createClass({
  ...
  render: function() {
    return (
      <Layout metadata={{"id":"contributing","title":"How to Contribute","layout":"docs","category":"Guides","permalink":"docs/contributing.html","next":"testing","previous":"upgrading","filename":"Contributing.md"}}>
        {content}
      </Layout>
    );
  }
