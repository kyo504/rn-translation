...
var Post = React.createClass({
  ...
  render: function() {
    return (
      <Layout metadata={{"id":"more-resources","title":"기타 리소스","layout":"docs","category":"The Basics","permalink":"docs/more-resources.html","next":"components","previous":"network","filename":"MoreResources.md"}}>
        {content}
      </Layout>
    );
  }
