...
var Post = React.createClass({
  ...
  render: function() {
    return (
      <Layout metadata={{"id":"native-modules-android","title":"Native Modules","layout":"docs","category":"Guides (Android)","permalink":"docs/native-modules-android.html","banner":"ejected","next":"native-components-android","previous":"building-for-apple-tv","filename":"NativeModulesAndroid.md"}}>
        {content}
      </Layout>
    );
  }
