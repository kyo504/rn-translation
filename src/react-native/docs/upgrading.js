...
var Post = React.createClass({
  ...
  render: function() {
    return (
      <Layout metadata={{"id":"upgrading","title":"Upgrading to new React Native versions","layout":"docs","category":"Guides","permalink":"docs/upgrading.html","next":"contributing","previous":"running-on-device","filename":"Upgrading.md"}}>
        {content}
      </Layout>
    );
  }
