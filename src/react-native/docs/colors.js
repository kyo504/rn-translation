...
React Native는 16진수와 함수 표기법을 통해 \`rgb()\`와 \`rgba()\`를 지원합니다. 
...
var Post = React.createClass({
  ...
  render: function() {
    return (
      <Layout metadata={{"id":"colors","title":"색상 레퍼런스","layout":"docs","category":"Guides","permalink":"docs/colors.html","next":"integration-with-existing-apps","previous":"direct-manipulation","filename":"Colors.md"}}>
        {content}
      </Layout>
    );
  }
