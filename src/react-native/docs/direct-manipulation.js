...
var Post = React.createClass({
  ...
  render: function() {
    return (
      <Layout metadata={{"id":"direct-manipulation","title":"Direct Manipulation","layout":"docs","category":"Guides","permalink":"docs/direct-manipulation.html","next":"colors","previous":"javascript-environment","filename":"DirectManipulation.md"}}>
        {content}
      </Layout>
    );
  }
