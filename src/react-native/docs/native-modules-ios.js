...
var Post = React.createClass({
  ...
  render: function() {
    return (
      <Layout metadata={{"id":"native-modules-ios","title":"Native Modules","layout":"docs","category":"Guides (iOS)","permalink":"docs/native-modules-ios.html","banner":"ejected","next":"native-components-ios","previous":"testing","filename":"NativeModulesIOS.md"}}>
        {content}
      </Layout>
    );
  }
