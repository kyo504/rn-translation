...
var Post = React.createClass({
  ...
  render: function() {
    return (
      <Layout metadata={{"id":"troubleshooting","title":"Troubleshooting","layout":"docs","category":"Quick Start","permalink":"docs/troubleshooting.html","filename":"Troubleshooting.md"}}>
        {content}
      </Layout>
    );
  }
