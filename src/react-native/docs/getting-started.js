...
var Post = React.createClass({
  ...
  render: function() {
    return (
      <Layout metadata={{"id":"quick-start-getting-started","title":"Getting Started","layout":"docs","category":"The Basics","permalink":"docs/getting-started.html","next":"tutorial","filename":"GettingStarted.md"}}>
        {content}
      </Layout>
    );
  }
