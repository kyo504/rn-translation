...
var Post = React.createClass({
  ...
  render: function() {
    return (
      <Layout metadata={{"id":"building-for-apple-tv","title":"Building For Apple TV","layout":"docs","category":"Guides (iOS)","permalink":"docs/building-for-apple-tv.html","banner":"ejected","next":"native-modules-android","previous":"communication-ios","filename":"BuildingForAppleTV.md"}}>
        {content}
      </Layout>
    );
  }
