...
var Post = React.createClass({
  ...
  render: function() {
    return (
      <Layout metadata={{"id":"components","title":"컴포넌트와 API","layout":"docs","category":"Guides","permalink":"docs/components-and-apis.html","next":"platform-specific-code","previous":"more-resources","filename":"ComponentsAndAPIs.md"}}>
        {content}
      </Layout>
    );
  }
