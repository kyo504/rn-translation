...
var content = `\{
  ...
  "methods": [
    ...
    \{
      "name": "scrollToIndex",
      "docblock": "Scrolls to the item at the specified index such that it is positioned in the viewable area\\nsuch that \`viewPosition\` 0 places it at the top, 1 at the bottom, and 0.5 centered in the\\nmiddle. \`viewOffset\` is a fixed number of pixels to offset the final target position.\\n\\nNote: cannot scroll to locations outside the render window without specifying the\\n\`getItemLayout\` prop.",
      "modifiers": [],
      "params": [
        \{
          "name": "params",
      ...
      "returns": null,
      "description": "Scrolls to the item at the specified index such that it is positioned in the viewable area\\nsuch that \`viewPosition\` 0 places it at the top, 1 at the bottom, and 0.5 centered in the\\nmiddle. \`viewOffset\` is a fixed number of pixels to offset the final target position.\\n\\nNote: cannot scroll to locations outside the render window without specifying the\\n\`getItemLayout\` prop."
    },
    \{
      "name": "scrollToItem",
