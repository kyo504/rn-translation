...
var content = `\{
  "description": "Do not use unless you have a very good reason. All elements that\\nrespond to press should have a visual feedback when touched.\\n\\nTouchableWithoutFeedback supports only one child.\\nIf you wish to have several child components, wrap them in a View.",
  ...
  "props": \{
    ...
    "onPressIn": \{
      ...
      "required": false,
      "description": "Called as soon as the touchable element is pressed and invoked even before onPress.\\nThis can be useful when making network requests."
    },
    "onPressOut": \{
      "type": \{
        "name": "func"
    ...
    "hitSlop": \{
      ...
      "required": false,
      "description": "This defines how far your touch can start away from the button. This is\\nadded to \`pressRetentionOffset\` when moving off of the button.\\n** NOTE **\\nThe touch area never extends past the parent view bounds and the Z-index\\nof sibling views always takes precedence if a touch hits two overlapping\\nviews."
    }
  },
  "typedef": [
    \{
