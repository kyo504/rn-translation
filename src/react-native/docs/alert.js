...
var Post = React.createClass({
  ...
  render: function() {
    return (
      <Layout metadata={{"id":"alert","title":"Alert","layout":"autodocs","category":"APIs","permalink":"docs/alert.html","platform":"cross","next":"alertios","previous":"adsupportios","sidebar":true,"path":"Libraries/Alert/Alert.js","filename":null}}>
        {content}
      </Layout>
    );
  }
