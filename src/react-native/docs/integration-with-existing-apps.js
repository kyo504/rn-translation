...
var Post = React.createClass({
  ...
  render: function() {
    return (
      <Layout metadata={{"id":"integration-with-existing-apps","title":"Integration With Existing Apps","layout":"docs","category":"Guides","permalink":"docs/integration-with-existing-apps.html","banner":"ejected","next":"running-on-device","previous":"colors","filename":"IntegrationWithExistingApps.md"}}>
        {content}
      </Layout>
    );
  }
