...
var Post = React.createClass({
  ...
  render: function() {
    return (
      <Layout metadata={{"id":"android-building-from-source","title":"Building React Native from source","layout":"docs","category":"Guides (Android)","permalink":"docs/android-building-from-source.html","banner":"ejected","next":"activityindicator","previous":"android-ui-performance","filename":"AndroidBuildingFromSource.md"}}>
        {content}
      </Layout>
    );
  }
