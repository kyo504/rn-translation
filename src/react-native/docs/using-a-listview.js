...
여러분이 논리적 섹션으로 분할 된 데이터를 렌더링 하고 싶으면, iOS \`유아이 테이블 뷰(UITableView)\`와 비슷한 섹션 헤더를 사용하는 [섹션리스트(SectionList)](docs/sectionlist.html)를 선택하는 방법이 있습니다.
...
var Post = React.createClass({
  ...
  render: function() {
    return (
      <Layout metadata={{"id":"using-a-listview","title":"리스트 뷰(List Views) 사용법","layout":"docs","category":"The Basics","permalink":"docs/using-a-listview.html","next":"network","previous":"using-a-scrollview","filename":"UsingAListView.md"}}>
        {content}
      </Layout>
    );
  }
